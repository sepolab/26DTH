...
//------------------------------------------------------------
//PROCESS BY DATE:
// JUL22,2016: CREATED DATE - JSON SYNTAX LOOKS LIKE = {"DT":"AC/WF","B":"Toshiba","State":"on","M":"cool","T":"27","F":"max","S":"n"}
//    
// 
//------------------------------------------------------------
...
//    wifiManager.addParameter(&custom_GeneralPublish_topic);
    ...
    WiFi.macAddress(mac);
    char temptSSID [20] = "";
    snprintf(temptSSID, 20, "%02X%02X%02X%02X%02X%02X", mac[0], mac[1], mac[2], mac[3], mac[4], mac[5]);
